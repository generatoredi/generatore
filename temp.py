API_KEY = "79ffI5DFbaCy0DnQKQixu0EMJ"
API_SECRET = "Z1Cbg5ZWyYHCdepQIurF2Zzkjh2NTM9W3rdq3ODHe5GYrGBG8v"
ACCESS_TOKEN = "1253699637032054785-jL1klm46RvEOjeirkNFXlFySShpAJM"
ACCESS_TOKEN_SECRET = "2RvD6sfwNf6Fu0rD4pAnrgo4OihlXujyI5biAGoNdPLr4"
...
# Get words
corpusPath = os.path.dirname(os.path.realpath(__file__)) + "/poetry.txt"
...
def createGoodTweet(wordLines):
	...
	while hasMessage is False:
		...
		if len(message) != 1 and message[0].isalpha():
			hasMessage = True
